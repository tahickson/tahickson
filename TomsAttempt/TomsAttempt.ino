...
const char *LoggerID = "TomTestLogger";
// How frequently (in minutes) to log data
const uint8_t loggingInterval = 15;
// Your logger's timezone.
const int8_t timeZone = -6; //CST
...
// const int8_t I2CPower = 22;  // Pin to switch power on and off (-1 if unconnected)
const uint8_t MS5803i2c_addr = 0x77;  // The MS5803 can be addressed either as 0x76 or 0x77
const int MS5803maxPressure = 2;  // The maximum pressure measurable by the specific MS5803 model
const uint8_t MS5803ReadingsToAvg = 5;
...
Variable *variableList[] = {
    ...
    new BoschBME280_Temp(&bme280, "908f01ea-1dc8-4a4a-8ce7-c3fa9ed4d92a"),
    new BoschBME280_Humidity(&bme280, "56ebc957-251d-49b2-8cf0-9db5718afafc"),
    new BoschBME280_Pressure(&bme280, "e2941637-9c01-4067-8fa1-d8713cc55c1d"),
    new BoschBME280_Altitude(&bme280, "91c4a8a2-604f-4aae-b6c7-5b2bcd653687"),
    ...
    new MaximDS18_Temp(&ds18_u, "56a9165b-b7ee-406d-9c13-3a11c90e5a53"),
    ...
    new MeaSpecMS5803_Temp(&ms5803, "c707cf2c-519a-4a4c-bb26-a709b396f6f7"),
    new MeaSpecMS5803_Pressure(&ms5803, "81fd0222-a9ee-4c82-a89d-7fec29b038a8"),
    ...
    new ProcessorStats_Batt(&mayfly, "9fec8aa5-f71d-4d16-8fa2-63b245be1748"),
...
// ==========================================================================
const char *registrationToken = "97ca16cd-97db-4df1-9b68-a0c24a4917fe";   // Device registration token
const char *samplingFeature = "1fb2d431-4707-4fff-937a-7909c29b843f";     // Sampling feature UUID
